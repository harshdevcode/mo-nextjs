...
import MoSuccess from "../../../pages/signupsuccess";
...
export default function BusinessFreeTrialForm() {
  ...
  const formik = useFormik({
    initialValues: {
      username: "harshraj1100@xecurify.com",
      fname: "harsh",
      lname: "raj",
      aoi: "",
      areaOfInterest: "",
    ...
    <div className="vh-100 d-flex flex-column mt-4 ms-2">
      {!hasError ? (
        <form
          ...
          role="form"
          id="signupform"
          action="https://test.miniorange.in/moas/savedemocustomer"
        >
          <div style={formStyle}>
            <InputLabel htmlFor="aoi" sx={{ color: "rgba(0, 0, 0, 0.54)" }}>
          ...
          <Grid container spacing={2} alignItems="center" className="mt-3">
            ...
            <Grid item xs={6} className="">
              ...
              <PhoneInput
                className={`ms-1 mt-2 ${styles["custom-dropdown"]}`}
                country={"in"}
                value={phone}
                buttonStyle={{
                ...
                dropdownClass="custom-dropdown" // Add custom class for dropdown
              />
              {!valid && (
                <FormHelperText sx={{ color: "red" }}>
          ...
          <Grid container spacing={2} alignItems="center" className="mt-1">
            <Grid item xs={6} style={formStyle}>
              ...
              <InputLabel htmlFor="fname" sx={{ color: "rgba(0, 0, 0, 0.54)" }}>
            ...
            <Grid item xs={6} style={formStyle}>
              {" "}
              {/* Adjusted from xs={6} to xs={5} */}
              <InputLabel htmlFor="lname" sx={{ color: "rgba(0, 0, 0, 0.54)" }}>
          ...
          <div className="mb-3 mt-3">
            <InputLabel htmlFor="query" sx={{ color: "rgba(0, 0, 0, 0.54)" }}>
              Write your Query
            </InputLabel>
            <TextField
              className="mt-2"
